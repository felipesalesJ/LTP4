...
<c:when test="${Lista.size()>0}">
	...
	<tr>
		...
		<td>
		<input type="button" onclick="location='/LTP4-Livraria/livro?acao=SEARCH&id=${l.id}'" value="UPDATE">
		<input type="button" onclick="location='/LTP4-Livraria/livro?acao=DELETE&id=${l.id}'" value="DELETE">
